...
import { ALERT, NEW_ATTACHEMNT, NEW_MESSAGE_ALERT, REFETCH_CHATS } from "../constants/events.js";
...
const removeMembers = tryCatch(async (req, res, next) => {
    ...
    emitEvent(req, ALERT, chat.members, `${userThatWillBeRemoved.name} has been removed from the froup`);
...
const sendAttachments = tryCatch(async (req, res, next) => {
    ...
    emitEvent(req, NEW_ATTACHEMNT, chat.members, {
